                    ...
                    <div class="border rounded-lg overflow-hidden">
                        <div class="border-b px-6 py-4 bg-gray-50 flex items-center justify-between">
                            ...
                            <form @submit.prevent="getCashes" class="flex items-center">
                                ...
                                <button class="px-3 py-2 rounded bg-gradient-to-br from-blue-500 to-light-blue-500 text-white focus:outline-none">
                                    Go
                                </button>
                            </form>
                        </div>
            ...
            <div class="w-full lg:w-4/12">
                ...
                <form @submit.prevent="add">
                    <div class="mb-5">
                        ...
                        <input type="text" v-model="form.name" name="name" id="name" class="w-full border rounded-lg focus:outline-none focus:ring focus:border-blue-400 h-10 px-4 transition duration-150 placeholder-gray-500 placeholder-opacity-50" placeholder="Name">
                    </div>
                    <div class="mb-5">
                        <label for="amount" class="text-xs uppercase font-medium block mb-2">
                            Amount
                        </label>
                        <input type="text" v-model="form.amount" name="amount" id="amount" class="w-full border rounded-lg focus:outline-none focus:ring focus:border-blue-400 h-10 px-4 transition duration-150 placeholder-gray-500 placeholder-opacity-50" placeholder="Amount">
                    </div>
                    <div class="mb-5">
