                ...
                <div class="p-4">
                    <form @submit.prevent="login">
                        <div class="mb-5">
                            ...
                            <input type="email" v-model="credential.email" name="email" id="email" class="w-full border rounded-lg focus:outline-none focus:ring focus:border-blue-400 h-10 px-4 transition duration-150 placeholder-gray-500 placeholder-opacity-50" placeholder="Email">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="password" v-model="credential.password" name="password" id="password" class="w-full border rounded-lg focus:outline-none focus:ring focus:border-blue-400 h-10 px-4 transition duration-150 placeholder-gray-500 placeholder-opacity-50" placeholder="Password">
